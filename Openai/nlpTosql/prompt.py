...
def create_table_definition_prompt(df, table_name):
    ...
    prompt = '''### postgres table, with its properties:
#
# {}({})
#
...
def combine_prompts(fixed_sql_prompt, user_query):
    ...
    """
    final_user_input = f"### Postgres requires table names and columns to be enclosed by double apices\nA query to answer: {user_query}\nSELECT"
